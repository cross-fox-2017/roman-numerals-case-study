...
1. Apakah semua solusi bisa di eksekusi? Bagaimana caranya mem-verifikasinya?
   Semua solusi bisa di eksekusi tapi ada beberapa output yang masih kurang tepat

2. Apakah ada solusi code yang mengandung *bugs*? Dan bagaimana cara mem-verifikasinya?
   ada pada solusi 3, seharusnya test case to_roman(1453) dan to_roman(1646) outputnya keluar

3. Adakah sintaks baru yang belum kamu ketahui? Apakah ada operator baru, expression atau method baru?
   semua sudah saya ketahui tapi agak bingung di penulisan sintaks "(+decimalValue[index]" bingung di "+" soalnya belum pernah ngesolve soal pake sintaks seperti itu
...
5. Dapatkah kamu gunakan sintaks baru yang kamu temui di sini di *project* kamu berikutnya?
   saya dapat gunakan sintaks baru yang saya temui disini untuk menyelesaikan tugas berikutnya
...
7. Apa yang dapat kamu pelajari dari perspektif yang berbeda dari berbagai solution code? Apakah benar-benar berbeda? Jika ya, kenapa berbeda? Debat! Cari tau.
	Banyak cara untuk menyelesaikan cara atau pola untuk menyelesaikan masalah
	namun, dari banyak cara tersebut kita harus temukan cara yang paling simple dan mudah di baca 
8. Jika kamu harus memilih satu, mana yang menurut kamu yang merupakan solsi terbaik, dan kenapa? Diskusikan dengan teman kelompok kamu tentang hal ini.
   yang terbaik adalah solusi 4 karena sintaks nya yang mudah untuk di dibaca
...
10. Apakah dampak dari pola atau pattern terhadap maintenance code? Kenapa kamu bisa yakin?
	Dampaknya mudah untuk di maintanance terutama solusi nomer 4 karena singkat dan mudah di fahami/dibaca oleh orang lain
*/
